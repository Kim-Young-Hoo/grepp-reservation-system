...
from exams.models import ExamSlot
...
class Reservation(models.Model):
    ...
    exam_slot = models.ForeignKey(ExamSlot, db_index=True, on_delete=models.CASCADE, related_name='reservations', help_text="예약된 시험 슬롯")
